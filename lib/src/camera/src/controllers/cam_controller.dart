...
class CamController extends ValueNotifier<CamValue> {
  ...
  CamController() : super(const CamValue()) {
    ...
    _kushEditingController = KushEditingController();
  ...
  late final KushEditingController _kushEditingController;
  ...
  KushEditingController get kushEditingController => _kushEditingController;
  ...
  ///
  /// Take picture
  Future<GalleryPickerEntity?> takePicture(BuildContext context) async {
    ...
    try {
      ...
      if (_setting.editAfterCapture) {
        ...
        if (entity != null) {
          final GalleryPickerEntity = entity.toDrishya.copyWith(
            pickedThumbData: bytes,
            pickedFile: file,
          );
          if (navigator.mounted) {
            navigator.pop([GalleryPickerEntity]);
          }
          return GalleryPickerEntity;
        } else {
          final exception = CameraException(
            'takePictyre',
  ...
  Future<GalleryPickerEntity?> stopVideoRecording(
  ...
  void dispose() {
    ...
    _kushEditingController.dispose();
