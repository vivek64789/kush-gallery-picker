...
import 'package:kush_gallery_picker/src/editor/src/widgets/color_picker.dart';
import 'package:kush_gallery_picker/src/editor/src/widgets/editor_overlay.dart';
import 'package:kush_gallery_picker/src/editor/src/widgets/editor_textfield.dart';
import 'package:kush_gallery_picker/src/editor/src/widgets/editor_textfield_button.dart';
import 'package:kush_gallery_picker/src/editor/src/widgets/stickers_view.dart';
...
class DrishyaEditor extends StatefulWidget {
  ...
  /// Open drishya editor
  static Future<GalleryPickerEntity?> open(
    BuildContext context, {
    KushEditingController? controller,
    EditorSetting? setting,
    bool hideOverlay = false,
  }) async {
    return Navigator.of(context).push<GalleryPickerEntity>(
...
class _DrishyaEditorState extends State<DrishyaEditor> {
  late KushEditingController _controller;

  @override
  void initState() {
    super.initState();
    UIHandler.hideStatusBar();
    _controller = (widget.controller ?? KushEditingController())
