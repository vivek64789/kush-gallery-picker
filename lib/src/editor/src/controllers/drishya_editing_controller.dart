...
import 'package:kush_gallery_picker/src/editor/src/widgets/draggable_resizable.dart';
import 'package:meta/meta.dart';
import 'package:uuid/uuid.dart';

/// Drishya editing controller
class KushEditingController extends ValueNotifier<EditorValue> {
  ///
  /// Drishya editing controller
  KushEditingController()
  ...
  Future<GalleryPickerEntity?> completeEditing({
