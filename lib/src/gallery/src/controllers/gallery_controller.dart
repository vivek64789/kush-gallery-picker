...
class GalleryController extends ValueNotifier<GalleryValue> {
  ...
  late Completer<List<GalleryPickerEntity>> _completer;
  ...
  void Function(GalleryPickerEntity entity, bool removed)? _onChanged;
  ...
  @internal
  Future<GalleryPickerEntity?> openCamera(BuildContext context) async {
    final uiHandler = UIHandler.of(context);

    final route = SlideTransitionPageRoute<List<GalleryPickerEntity>>(
      builder: CameraView(
  ...
  @internal
  Future<GalleryPickerEntity?> editEntity(
    BuildContext context,
    GalleryPickerEntity entity,
  ) async {
    //
    ...
    final route = SlideTransitionPageRoute<GalleryPickerEntity>(
  ...
  @internal
  Future<List<GalleryPickerEntity>> onGalleryFieldPressed(
    BuildContext context, {
    void Function(GalleryPickerEntity entity, bool removed)? onChanged,
  ...
  Future<List<GalleryPickerEntity>> _collapsableGallery(BuildContext context) {
    _completer = Completer<List<GalleryPickerEntity>>();
  ...
  @internal
  List<GalleryPickerEntity> completeTask(
    BuildContext context, {
    List<GalleryPickerEntity>? items,
  }) {
  ...
  ///
  /// Pick assets
  Future<List<GalleryPickerEntity>> pick(
    BuildContext context, {
    GallerySetting? setting,
    CustomRouteSetting? routeSetting,
  }) async {
  ...
  Future<List<GalleryPickerEntity>> recentEntities({
    RequestType? type,
    int count = 20,
  }) {
    final albums = Albums();
